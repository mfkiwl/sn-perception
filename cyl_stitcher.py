...
class CylindricalStitcher:
    def __init__(self, height, width, f=1100):
        ...
        self.H_1 = np.array([[ 1.71648693e+00, -2.51997439e-03, -9.16959396e+02],
                             [ 3.38390810e-01,  1.49053970e+00, -3.24351586e+02],
                             [ 5.45717951e-04, -5.23298441e-06,  1.00000000e+00]])

                           

        self.H_2 = np.array( [[ 3.13621090e-01,  3.59610024e-02,  1.46188908e+03],
                              [-2.89265843e-01,  8.99175883e-01,  4.03567269e+02],
                              [-3.11761320e-04,  2.75153672e-05,  1.00000000e+00]])
        
        self.new_height_l = 1074
        self.new_width_l = 2064
        self.corr_l = [922, 324]

        self.H_l_corr = np.array([[ 2.21963877e+00, -7.34478574e-03,  5.04060364e+00],
                                  [ 5.15203388e-01,  1.48884410e+00, -3.51586431e-01],
                                  [ 5.45717904e-04, -5.23304011e-06,  1.00000000e+00]])

        self.new_height_r = 1084
        self.new_width_r = 2824
        self.corr_r = [0, 0]

        self.H_r_corr = np.array([[ 3.13621154e-01,  3.59611854e-02,  1.46188904e+03],
                                  [-2.89265836e-01,  8.99175891e-01,  4.03567261e+02],
                                  [-3.11761318e-04,  2.75154291e-05,  1.00000000e+00]])
