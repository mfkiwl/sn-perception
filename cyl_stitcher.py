...
class CylindricalStitcher:
    def __init__(self, height, width, f=1100):
        ...
        self.H_1 = np.array([[ 2.47720290e+00, 2.22514661e-02, -1.40523027e+03],
                             [ 6.02931798e-01, 2.14947063e+00, -5.98089125e+02],
                             [ 1.08048453e-03, 2.06359858e-04, 1.00000000e+00]])

        self.H_2 = np.array([[-2.28512681e-02, 1.28052238e-01, 1.95938668e+03],
                             [-4.32820050e-01, 9.10255251e-01, 6.78649618e+02],
                             [-3.81077944e-04, 4.06873909e-05, 1.00000000e+00]])
        
        self.new_height_l = 1423
        self.new_width_l = 2590
        self.corr_l = [1404, 597]

        self.H_l_corr = np.array([[ 3.99438899e+00, 3.04494195e-01, -1.55321985e-01],
                                  [ 1.24882121e+00, 2.26671830e+00, -4.08735603e-01],
                                  [ 1.08140037e-03, 2.02015930e-04, 1.00000000e+00]])

        self.new_height_r = 1423
        self.new_width_r = 3459
        self.corr_r = [0, 0]

        self.H_r_corr = np.array([[ 2.29719085e-02, 2.68385957e-02, 1.97072766e+03],
                                  [-3.93710986e-01, 8.67832454e-01, 6.72642456e+02],
                                  [-3.51454903e-04, -3.69175679e-07, 1.00000000e+00]])
